const ownerNumber = ["554884213536@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '554884213536' 
...
const msgerr = 'Deu erro, pode ter sido o burro do meu criador que mexeu nos códigos'
// mensagem de erro
...
const botgostoso = 'Tá me chamando de kuro?😳👉👈'
const botfofo ='Me confundiu com o neto 😳👉👈'
...
let mess = {
    wait: 'perae lek bot ta trabalhando',
    success: '✔️ Sucesso! ✔️',
    error: {
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=554884213536:+55 48 8421-3536\n' 
+ 'END:VCARD'
